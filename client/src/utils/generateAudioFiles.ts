/**
 * Utility script untuk melihat hash dari setiap dialog
...
// Gunakan script ini di browser console untuk melihat hash dialog
// Kemudian beri nama file audio sesuai dengan hash ini