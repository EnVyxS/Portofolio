...
const SocialLink = ({ name, url, icon, color, hoverColor }) => {
  ...
  return (
    <motion.a
      ...
      onTouchStart={triggerGlitch} /* Dukungan untuk device sentuh */
      onTouchEnd={triggerGlitch} /* Dukungan untuk device sentuh */
    ...
    >
      ...
      <style jsx>{`
        ...
        .social-link {
          display: flex;
          align-items: center;
          padding: clamp(0.6rem, 2vw, 0.85rem) clamp(0.7rem, 3vw, 1rem); /* Padding responsif */
          border-radius: 10px;
          ...
          width: 100%;
          -webkit-tap-highlight-color: transparent; /* Hapus highlight tap default di mobile */
          touch-action: manipulation; /* Lebih responsif untuk sentuhan */
        }
        ...
        .icon-container {
          ...
          width: clamp(32px, 6vw, 40px); /* Icon size responsif */
          height: clamp(32px, 6vw, 40px); /* Icon size responsif */
          border-radius: 8px;
          margin-right: clamp(0.8rem, 3vw, 1.2rem); /* Margin responsif */
          transition: all 0.3s ease;
        }
        ...
        .link-text {
          ...
          flex-grow: 1;
          gap: clamp(1.5rem, 4vw, 2.5rem); /* Jarak yang lebih lebar antara nama dan arrow */
          font-size: clamp(0.9rem, 3vw, 1rem); /* Font size responsif */
        }
